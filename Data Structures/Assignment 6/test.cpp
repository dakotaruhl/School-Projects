...
void tableOfSquares(int[], int, int i);
int raiseToPower(int, int);
int sumOfSquares(int[], int, int, int);
void minF(int [], int , int &, int &, int);
void bubbleSort(int [], int, int );
bool isMember(int [], int, int, int);
bool notMember(int [], int, int, int);
...
do
{
        ...
        int max = -1;
//        i = 0;
//        minF(myArray, arraySize, min, max);
...
// returns: none
//*******************************************************************
void tableOfSquares(int theArray[], int theSize)
{
    int temp = i;
    int i = 0;
    ...
    tableOfSquares(theArray, theSize, i);
}
...
int sumOfSquares(int theArray[], int theSize, int i, int sum)
{
    ...
    sumOfSquares(theArray, theSize, i, sum);
}
...
// returns: void
//*******************************************************************
void minF(int theArray[], int theSize, int &min, int &max, int i)
{
    ...
    if (min > theArray[i])
    {
        if (theArray[i] != theArray[theSize-1])
        {
            min = theArray[i];
            i++;
            minF(theArray, theSize, min, max, i);
        }
        else
        {
            if (min > theArray[i])
...
bool isMember(int theArray[], int theSize, int value, int i)
{
    if (theArray[i] != theArray[theSize-1])
    {
        ...
        {
            i++;
            isMember(theArray, theSize, value, i);
        }
    }
    else
    {
...
bool notMember(int theArray[], int first, int last, int value)
{
    if (first <= last)
    {
       ...
       else if (value < theArray[mid])
       {
           ...
           return notMember(theArray, first, mid-1, value);
       }
       else
       {
           // Call ourself for the upper part of the array
           return notMember(theArray, mid+1, last, value);
       }
    }
    else
    {
...
void isPrime(int theArray[], int theSize, int index)
{
    ...
    index++;
    isPrime(theArray, theSize, index);
}
